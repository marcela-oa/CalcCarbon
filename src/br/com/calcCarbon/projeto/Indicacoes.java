...
public class Indicacoes extends Carbono {
	...
	public void resultados () {
		System.out.println("A sua média de emissões semanal é: " + super.getTotalSemanal() + " t de CO2 \n");
		System.out.println("A sua média de emissões anual é: " + super.getTotalAnual() + " t de CO2 \n");
		System.out.println("A sua média de emissões da vida até agora é: " + super.getTotalVitalicio() + " t de CO2 \n");
	}
	
	public void indicações (String nome) {
		if (super.getTotalAnual() <= 7.0) {
			System.out.println("Parabéns, " + nome + "! Você está abaixo da média de emissões anual dos brasileiros!!\n"
			...
			System.out.println(nome + ", você está dentro da média de emissões anual dos brasileiros. O que acha de ajudar um pouco mais?\n"
			...
			System.out.println(nome + ", infelizmente suas emissões estão acima da média de emissões anual dos brasileiros :( \n"
